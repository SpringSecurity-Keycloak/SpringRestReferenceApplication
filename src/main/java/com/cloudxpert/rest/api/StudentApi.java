...
public interface StudentApi {
    ...
    @RequestMapping(value = "/api/v1/StudentResource/{StudentResourceId}",
    ...
    @ApiResponses(value = { 
        ...
        @ApiResponse(code = 500, message = "Internal Server Error") })
    @RequestMapping(value = "/api/v1/StudentResource/list",
        produces = { "application/json" }, 
        method = RequestMethod.GET)
    ...
    @ApiResponses(value = { 
        ...
        @ApiResponse(code = 500, message = "Internal Server Error") })
    @RequestMapping(value = "/api/v1/StudentResource",
        produces = { "application/json" }, 
