...
public interface StudentApi {
	...
	@ApiOperation(value = "Delete a student", nickname = "deleteV1StudentStudentId", notes = "Delete a student", tags={ "Student", })
    @ApiResponses(value = { 
        @ApiResponse(code = 200, message = "OK"),
        @ApiResponse(code = 404, message = "Not Found"),
        @ApiResponse(code = 500, message = "Internal Server Error") })
    @RequestMapping(value = "/v1/student/{studentId}",
        method = RequestMethod.DELETE)
    ResponseEntity<Void> deleteStudent(@ApiParam(value = "",required=true) @PathVariable("studentId") Integer studentId);

	@ApiOperation(value = "Retrieve All Students", nickname = "getV1StudentList", notes = "Retrieve a list of all the students", response = StudentResource.class, responseContainer = "List", tags = {
			"Student", })
	@ApiResponses(value = {
	...
	@ApiOperation(value = "", nickname = "postV1Student", notes = "Add a new Student", response = StudentResource.class, tags = {
			"Student", })
	...
	@ApiOperation(value = "Update student details", nickname = "putV1StudentStudentId", notes = "Update a student details", tags = {
			"Student", })
